...
function login() {
  ...
  const setTokenCookie = (token) => {
    ...
    const expirationMinutes = 1; //expiration time in minutes
    ...
    <div className="flex justify-center items-center h-screen">
      ...
      <div className="h-3/5 w-3/5 md:flex">
        <div
          ...
          className={`relative overflow-hidden md:flex w-1/2 bg-[url('/123.jpg')] mr-5 bg-repeat-round  justify-around items-center hidden`}
        >
          {/* Text inside  */}
        </div>
        <div className="flex md:w-1/2 justify-center ml-5 py-10 items-center bg-white">
          <form method="POST" onSubmit={Loginform} className="bg-white">
            ...
            <p className="text-sm font-normal text-gray-600 mb-7">Welcome PRO</p>
