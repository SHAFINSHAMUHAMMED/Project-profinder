...
function Success({orderData}) {
  ...
  return (
    <div className='w-[250px] md:w-[400px] lg:w-[500px]'>
      ...
      <div className='text-end text-3xl me-5 text-slate-600 pt-2 hover:cursor-pointer' onClick={closeHandle}>x</div>

      <div className='relative'>
    <img className='h-[5rem] sm:h-[10rem] m-auto' src="/icons/succes.gif" alt="" />
    <h2 className=' absolute top-3/4 mt-5 sm:mt-0 inset-0 flex items-center justify-center pointer-events-none font-mono font-bold text-sm md:text-lg'>
      Booking Confirmed
        ...
        <div style={{backgroundColor: '#ECFDFF'}} className=" w-5/6 sm:w-3/4 m-auto mt-5 mb-5 sm:mt-0 p-2 sm:p-4 rounded-sm">
...
<div className='flex items-center justify-center '>
  <button style={{backgroundColor:'#1DEE8A'}} className='h-8 p-2 rounded-lg text-center flex items-center justify-center mb-5'>
    <span className="inline-block align-middle text-xs">View Bookings</span>
  </button>
</div>
