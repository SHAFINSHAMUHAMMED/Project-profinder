...
function proProfile() {
  ...
  const fetchData = async () => {
    try {
      if (!selectedDate) {
        ...
        setTimeout(async () => {
          try {
            const res = await userAxios.get(`/getBookings?proId=${proData._id}&selectedDate=${selectedDate}`, {
              headers: {
            ...
            if (res.data.status) {
              ...
              const workTypes = bookingsWithDate.map((booking) => booking.work_type);
              setLoading(false);
              ...
              if (workTypes.includes("Full Time")) {
                ...
                setSelectedTime("");
              } else if (workTypes.includes("Part Time1") && workTypes.includes("Part Time2")) {
                setDisableFullTimeSlots(true);
                setSelectedTime("");
                      ...
                      <div className="flex justify-center items-center">
                        <div className="flex flex-col">
                          ...
                          <div className="flex-auto text-gray-500 my-1">
                            ...
                            <span>{proData.location.location}</span>
                          </div>
                        </div>
                      </div>
        ...
        <div className="md:flex">
          <div className="w-full md:w-2/6  rounded-lg shadow-lg p-2 md:p-5">
            <div className="flex justify-center mb-2 md:mb-5">
              <div className="w-1/2">
                <h1 className="text-3xl  md:text-4xl xl:text-5xl font-bold">35</h1>
                <h5 className=" text-[65%] md:text-[75%] xl:text-[90%] font-medium">
                  Work Completed
                </h5>
              </div>
              <div className="">
                <h1 className="text-3xl  md:text-4xl xl:text-5xl font-bold">325</h1>
                <h5 className="text-[65%] md:text-[75%] xl:text-[90%] font-medium">
                  Total Hours
                </h5>
              </div>
  ...
  <input
    ...
    disabled={disableFullTimeSlots || disablePart1 || disableAll}
  />
  <label
    htmlFor="time1"
    className="sm:text-[80%]"
    style={{
      textDecoration: (disableFullTimeSlots || disablePart1) ? 'line-through red' : 'none'
    }}
  >
    8 am to 12 pm
  </label>
            ...
            onChange={handleTimeSelection}
            disabled={disableFullTimeSlots || disablePart2 || disableAll}
                        />
                        <label htmlFor="time2" 
                        className="sm:text-[80%]"
                        style={{
                          textDecoration: (disableFullTimeSlots || disablePart2) ? 'line-through red' : 'none'
                        }}
                        >
                          1 pm to 5 pm
                        </label>
            ...
            onChange={handleTimeSelection}
            disabled={disableFullTimeSlots || disablePart1 || disablePart2 || disableAll}
                        />
                        <label htmlFor="time3" 
                        className="sm:text-[80%]"
                        style={{
                          textDecoration: (disableFullTimeSlots || disablePart1 || disablePart2) ? 'line-through red' : 'none'
                        }}
                        >
                          8 am to 5 pm
                        </label>
                ...
                <div className="flex justify-center w-1/2 m-auto sm:ms-auto sm:me-20">
                  <button onClick={bookNow} className="mb-4 bg-white rounded-lg py-1 px-2 text-sm text-gray-700 font-bold hover:bg-gray-300">
                    Book Now
                  </button>
                </div>
              </div>
            ...
            <div className="bg-gray-100 p-4 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                <h3 className="text-md font-semibold ps-5">User Reviews (6)</h3>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="sm:flex items-center space-x-1 text-gray-500">
                    ...
                    <span className="text-yellow-500 sm:text-sm ">5.0</span>
                    <span className="text-sm">Jun 15, 2023</span>
                  </div>
                  <div className=" max-h-36 p-2 px-5 md:p-5 lg:pb-0 overflow-y-auto">
                    <p className=" w-full text-[85%] ">
                      Description about worker is a long established fact that a
                  ...
                  <h6 className="text-sm font-semibold ps-6">UserName</h6>
                </div>
