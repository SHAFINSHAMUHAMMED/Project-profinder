...
<div className="flex flex-col w-screen bg-gray-600 ">
      ...
      <div className="overflow-hidden">
        <table className="min-w-full">
          <thead className="bg-gray-200 border-b">
            <tr>
              <th scope="col" className="text-sm font-medium roun text-gray-900 px-6 py-4 text-center">
                Profile
              </th>
          ...
          <tbody key={pro._id}>
            <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                <img className='w-10 h-10 rounded-full' src="/ajmal.jpg" alt="" />
              </td>
              ...
              {data.category ? <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                {pro.location}
  ...
  <button onClick={() => blockUser(pro._id)} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 focus:outline-none focus:ring focus:ring-blue-300">
